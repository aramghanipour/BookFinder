...
var SignalRConnection = (function (_super) {
    ...
    function SignalRConnection(jConnection, jProxy, zone) {
        ...
        _this._jProxy = jProxy;
        _this._jConnection = jConnection;
        _this._zone = zone;
        _this._errors = _this.wireUpErrorsAsObservable();
        _this._status = _this.wireUpStatusEventsAsObservable();
        return _this;
    }
    ...
    SignalRConnection.prototype.wireUpErrorsAsObservable = function () {
        var _this = this;
        var sError = new ReplaySubject_1.ReplaySubject();
    ...
    SignalRConnection.prototype.wireUpStatusEventsAsObservable = function () {
        var _this = this;
        var sStatus = new ReplaySubject_1.ReplaySubject();
